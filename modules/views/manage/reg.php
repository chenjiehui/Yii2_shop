            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span9 with-sidebar">
                    ...
                    <?php if(Yii::$app->session->hasFlash('info'))
                        ...
                        ?>
                        <?= $form->field($model, 'adminUser')->textInput(['class' => 'span9'])->label('管理员用户名'); ?>
                        <?= $form->field($model, 'adminEmail')->textInput(['class' => 'span9'])->label('管理员邮箱'); ?>
                        <?= $form->field($model, 'adminPass')->passwordInput(['class' => 'span9'])->label('管理员密码'); ?>
