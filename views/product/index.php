                ...
                <ul class="product-list">
                    <?php foreach($tui as $pro): ?>
                        <li class="sidebar-product-list-item">
                            <div class="row">
                                <div class="col-xs-4 col-sm-4 no-margin">
                                    <a  href="<?= \yii\helpers\Url::to(['product/detail','productid'=>$pro['productid']])?>"><img alt="" src="<?php echo $pro['cover'] ?>-coversmall"  /></a>
                                </div>
                                <div class="col-xs-8 col-sm-8 no-margin">
                                    <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro['productid']]) ?>"><?php echo $pro['title'] ?></a>
                                    <div class="price">
                    ...
                    <?php foreach($tui as $pro): ?>
                        <div class="no-margin carousel-item product-item-holder hover size-medium">
                            <div class="product-item">
                                ...
                                <div class="image">
                                    <a  href="<?= \yii\helpers\Url::to(['product/detail','productid'=>$pro['productid']])?>"><img alt="" src="<?php echo $pro['cover'] ?>-covermiddle"  /></a>
                                </div>
                                <div class="body">
                                    <div class="title">
                                        <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro['productid']]) ?>"><?php echo $pro['title'] ?></a>
                                ...
                                <div class="row no-margin">
                                    <?php foreach($all as $pro): ?>
                                        <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                            <div class="product-item">
                                                <?php if ($pro['ishot']): ?>
                                                    <div class="ribbon red"><span>火爆</span></div>
                                                <?php endif; ?>
                                                <?php if ($pro['issale']): ?>
                                    ...
                                    <div class="product-item product-item-holder">
                                        ...
                                        <div class="row">
                                            <div class="no-margin col-xs-12 col-sm-4 image-holder">
                                                <div class="image">
                                                    <a href=" <?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro['productid']]) ?>"><img alt="" src="<?php echo $pro['cover'] ?>-covermiddle"  /></a>
                                                </div>
                                            </div><!-- /.image-holder -->
