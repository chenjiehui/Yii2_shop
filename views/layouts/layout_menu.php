                        ...
                        <div class="control-group">
                            ...
                            <ul class="categories-filter animate-dropdown">
                                <li class="dropdown">
                                    ...
                                    <a class="dropdown-toggle"  data-toggle="dropdown" href="category-grid.html">商品分类</a>
                ...
                <div class="yamm navbar">
                    ...
                    <div class="collapse navbar-collapse" id="mc-horizontal-menu-collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <a href="<?=\yii\helpers\Url::to(['product/index']); ?>" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><?=$top['title']?></a>
                                    ...
                                    <li><div class="yamm-content">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    ...
                                                    <ul>
                                                        <li><a href="<?php echo yii\helpers\Url::to(['product/index', 'cateid' => $child['cateid']]) ?>"><?= $child['title']?></a></li>
                                                    </ul>
                                                    <?php endforeach; ?>
                                                </div>
                                            </div>
